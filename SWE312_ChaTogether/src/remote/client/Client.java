...
public class Client extends UnicastRemoteObject implements ClientInterface{
    ...
    //constructer
    public Client(String name , ServerInterface server,JTextArea jtext1,JTextArea jtext2,JPanel jpanel) throws RemoteException{
        this.name = name;
        this.server = server;
        this.input = jtext1;
        this.output = jtext2;
        this.jpanel = jpanel;
        server.addClient((ClientInterface) this);
    }
    ...
    public void retrieveMessage(final String filename, final ArrayList<Integer> inc) throws RemoteException {
